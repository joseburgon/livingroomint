<x-base-layout>
    ...
    <div class="flex flex-col h-screen">
        <div class="w-full h-1/3 bg-white p-20">
            <div class="max-w-screen-md mx-auto">
                <div class="flex flex-row items-center">
                    <div class="text-green-500 mr-10">
                    ...
                    <h1 class="font-light text-5xl text-green-500">¡Muy bien!</h1>
                </div>
            </div>
        </div>
        <div class="w-full h-1/2 bg-gray-100 border-t border-b border-gray-300">
            <div class="max-w-screen-md mx-auto">
                <div class="flex flex-col py-20">
                    <h2 class="font-bold text-3xl mb-8">¡Gracias! Hemos recibido tu donación.</h2>
                    <p class="font-normal text-xl">Has realizado una donación por un valor de {{ $currency }} ${{ $amount }} a nuestra
                        comunidad.</p>
                    <p class="font-normal text-xl">Recibirás una notificación en {{ $email }} cuando la donación
                        haya sido procesada.</p>
                    <div class="flex mt-8">
                        <a href="#"
                           class="bg-black text-white text-xl px-6 py-2 rounded font-bold hover:bg-gray-800 transition duration-200 each-in-out">Hacer
                            otra donación</a>
                    </div>
                </div>
            </div>
