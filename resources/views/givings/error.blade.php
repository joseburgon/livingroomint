        ...
        <div class="w-full h-1/3 bg-white flex items-center lg:justify-start p-4 lg:p-20">
            <div class="max-w-screen-md mx-auto w-full">
                <div class="flex flex-row items-center">
                    ...
                    <h1 class="font-light text-4xl lg:text-5xl text-red-500">Algo salió mal</h1>
                </div>
            </div>
        </div>
        <div class="w-full h-1/2 bg-gray-100 border-t border-b border-gray-300">
            <div class="max-w-screen-md mx-auto">
                <div class="flex flex-col py-10 px-4 lg:px-0 lg:py-16">
                    ...
                    <p class="font-normal text-base lg:text-xl">Has intentado realizar una donación por un valor de
                        <strong>{{ $currency }} ${{ $amount }}</strong> a nuestra
                        comunidad.</p>
                    <p class="font-normal text-base lg:text-xl">Recibirás un mail en
                        <strong>{{ $email }}</strong> con el detalle del error de la transacción.
                    </p>
                    <div class="flex mt-8">
