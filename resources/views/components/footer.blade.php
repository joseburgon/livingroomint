<div class="w-full px-4 lg:px-0 {{ $bgColor }}">
    <div class="flex h-auto">
        <div class="pt-10 pb-4">
            <a href="https://www.livingroomint.org/">
                <img class="w-32" src="{{ asset('img/logo-livingroom-negro.svg') }}" alt="Logo Living Room">
            </a>
        </div>
    </div>
    <div class="flex pb-8 m-auto pt-5 border-t text-gray-400 text-sm flex-col md:flex-row max-w-6xl">
        <div class="mt-2">{{ '©'.date("Y").' Living Room. Todos los derechos reservados.'  }}</div>
