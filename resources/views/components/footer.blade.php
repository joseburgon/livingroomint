    ...
    <div class="flex h-auto">
        <div class="py-8">
            <a href="https://www.livingroomint.org/">
                <img class="w-36" src="{{ asset('img/logo-livingroom-negro.svg') }}" alt="Logo Living Room">
            </a>
        </div>
    </div>
    <div class="flex pb-3 m-auto pt-5 border-t text-gray-400 text-sm flex-col md:flex-row max-w-6xl">
