@php
    ...
    if ($active) $classes .= 'text-gray-800 dark:text-gray-100';
@endphp

<li class="relative px-6 py-3">
    @if($active)
        <span class="absolute inset-y-0 left-0 w-1 bg-purple-600 dark:bg-purple-600 rounded-tr-lg rounded-br-lg"
