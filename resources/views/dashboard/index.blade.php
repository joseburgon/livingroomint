<x-dashboard.layout>
    <div class="container px-6 mx-auto grid">
        <x-dashboard.page-title>Dashboard Administrativa</x-dashboard.page-title>
        ...
        >
            ...
            <!-- Chart's container -->
            <div id="givingsTypesChart" style="height: 300px;"></div>
        </div>
    </div>
